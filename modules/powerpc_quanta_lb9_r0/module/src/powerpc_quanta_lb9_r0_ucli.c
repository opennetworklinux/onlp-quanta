...
powerpc_quanta_lb9_r0_ucli_ucli__config__(ucli_context_t* uc)
{
    UCLI_HANDLER_MACRO_MODULE_CONFIG(powerpc_quanta_lb9_r0)
}
...
powerpc_quanta_lb9_r0_ucli_module__ =
    {
        "powerpc_quanta_lb9_r0_ucli",
        NULL,
        powerpc_quanta_lb9_r0_ucli_ucli_handlers__,
        NULL,
        NULL,
    };
