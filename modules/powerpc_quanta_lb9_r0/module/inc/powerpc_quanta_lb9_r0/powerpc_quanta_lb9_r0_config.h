 ...
 *
 * @file
 * @brief powerpc_quanta_lb9_r0 Configuration Header
 *
 * @addtogroup powerpc_quanta_lb9_r0-config
 * @{
 *
 *****************************************************************************/
...
#include <powerpc_quanta_lb9_r0_custom_config.h>
#endif
...
/**
 * POWERPC_QUANTA_LB9_R0_CONFIG_SYSFAN_RPM_MAX
 *
 * Maximum system fan speed. */


#ifndef POWERPC_QUANTA_LB9_R0_CONFIG_SYSFAN_RPM_MAX
#define POWERPC_QUANTA_LB9_R0_CONFIG_SYSFAN_RPM_MAX 14500
#endif
...
typedef struct powerpc_quanta_lb9_r0_config_settings_s {
    /** name */
    const char* name;
    /** value */
    const char* value;
} powerpc_quanta_lb9_r0_config_settings_t;

/** Configuration settings table. */
/** powerpc_quanta_lb9_r0_config_settings table. */
extern powerpc_quanta_lb9_r0_config_settings_t powerpc_quanta_lb9_r0_config_settings[];

/**
 * @brief Lookup a configuration setting.
 * @param setting The name of the configuration option to lookup.
 */
const char* powerpc_quanta_lb9_r0_config_lookup(const char* setting);

/**
 * @brief Show the compile-time configuration.
 * @param pvs The output stream.
 */
int powerpc_quanta_lb9_r0_config_show(struct aim_pvs_s* pvs);

/* <auto.end.cdefs(POWERPC_QUANTA_LB9_R0_CONFIG_HEADER).header> */

#include "powerpc_quanta_lb9_r0_porting.h"
