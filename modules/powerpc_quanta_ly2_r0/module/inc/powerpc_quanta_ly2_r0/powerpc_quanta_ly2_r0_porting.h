 ...
 *
 * @file
 * @brief powerpc_quanta_ly2_r0 Porting Macros.
 *
 * @addtogroup powerpc_quanta_ly2_r0-porting
 * @{
 *
 *****************************************************************************/
...
#ifndef POWERPC_QUANTA_LY2_R0_MALLOC
    #if defined(GLOBAL_MALLOC)
        #define POWERPC_QUANTA_LY2_R0_MALLOC GLOBAL_MALLOC
    #elif POWERPC_QUANTA_LY2_R0_CONFIG_PORTING_STDLIB == 1
        #define POWERPC_QUANTA_LY2_R0_MALLOC malloc
    #else
        #error The macro POWERPC_QUANTA_LY2_R0_MALLOC is required but cannot be defined.
    #endif
#endif

#ifndef POWERPC_QUANTA_LY2_R0_FREE
    #if defined(GLOBAL_FREE)
        #define POWERPC_QUANTA_LY2_R0_FREE GLOBAL_FREE
    #elif POWERPC_QUANTA_LY2_R0_CONFIG_PORTING_STDLIB == 1
        #define POWERPC_QUANTA_LY2_R0_FREE free
    #else
        #error The macro POWERPC_QUANTA_LY2_R0_FREE is required but cannot be defined.
    #endif
#endif
